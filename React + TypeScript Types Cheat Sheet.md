- [[#1. TypeScript Basics for React|1. TypeScript Basics for React]]
	- [[#1. TypeScript Basics for React#Primitive Types|Primitive Types]]
	- [[#1. TypeScript Basics for React#Arrays: `string[]` vs `Array<string>`|Arrays: `string[]` vs `Array<string>`]]
	- [[#1. TypeScript Basics for React#Objects and Object Shape Typing|Objects and Object Shape Typing]]
	- [[#1. TypeScript Basics for React#Optional Properties with `?`|Optional Properties with `?`]]
	- [[#1. TypeScript Basics for React#Union Types|Union Types]]
	- [[#1. TypeScript Basics for React#Literal Types|Literal Types]]
	- [[#1. TypeScript Basics for React#Type Aliases|Type Aliases]]
	- [[#1. TypeScript Basics for React#Interfaces|Interfaces]]
	- [[#1. TypeScript Basics for React#`type` vs `interface`|`type` vs `interface`]]
	- [[#1. TypeScript Basics for React#Generics|Generics]]
	- [[#1. TypeScript Basics for React#Utility Types Commonly Used in React|Utility Types Commonly Used in React]]
		- [[#Utility Types Commonly Used in React#`Partial<T>`|`Partial<T>`]]
		- [[#Utility Types Commonly Used in React#`Required<T>`|`Required<T>`]]
		- [[#Utility Types Commonly Used in React#`Pick<T, K>`|`Pick<T, K>`]]
		- [[#Utility Types Commonly Used in React#`Omit<T, K>`|`Omit<T, K>`]]
		- [[#Utility Types Commonly Used in React#`Record<K, T>`|`Record<K, T>`]]
		- [[#Utility Types Commonly Used in React#`Readonly<T>`|`Readonly<T>`]]
		- [[#Utility Types Commonly Used in React#`NonNullable<T>`|`NonNullable<T>`]]
		- [[#Utility Types Commonly Used in React#`ReturnType<T>`|`ReturnType<T>`]]
		- [[#Utility Types Commonly Used in React#`Parameters<T>`|`Parameters<T>`]]
		- [[#Utility Types Commonly Used in React#`Awaited<T>`|`Awaited<T>`]]
- [[#2. Typing React Components|2. Typing React Components]]
	- [[#2. Typing React Components#Function Components Without `React.FC`|Function Components Without `React.FC`]]
	- [[#2. Typing React Components#Component with No Props|Component with No Props]]
	- [[#2. Typing React Components#Required Props|Required Props]]
	- [[#2. Typing React Components#Optional Props|Optional Props]]
	- [[#2. Typing React Components#Default Prop Values with Destructuring Defaults|Default Prop Values with Destructuring Defaults]]
	- [[#2. Typing React Components#Children Props|Children Props]]
	- [[#2. Typing React Components#`React.ReactNode`|`React.ReactNode`]]
	- [[#2. Typing React Components#`React.ReactElement`|`React.ReactElement`]]
	- [[#2. Typing React Components#`JSX.Element`|`JSX.Element`]]
	- [[#2. Typing React Components#Children Type Selection|Children Type Selection]]
	- [[#2. Typing React Components#Explicit Return Type When Useful|Explicit Return Type When Useful]]
	- [[#2. Typing React Components#Why `React.FC` Is Optional|Why `React.FC` Is Optional]]
- [[#3. Props Patterns|3. Props Patterns]]
	- [[#3. Props Patterns#Basic Props|Basic Props]]
	- [[#3. Props Patterns#Props with Callback Functions|Props with Callback Functions]]
	- [[#3. Props Patterns#Props with Union Values|Props with Union Values]]
	- [[#3. Props Patterns#Props with Discriminated Unions|Props with Discriminated Unions]]
	- [[#3. Props Patterns#Props Extending Native HTML Attributes|Props Extending Native HTML Attributes]]
	- [[#3. Props Patterns#Avoiding Prop Name Conflicts When Extending Native Attributes|Avoiding Prop Name Conflicts When Extending Native Attributes]]
	- [[#3. Props Patterns#Component Composition Props|Component Composition Props]]
	- [[#3. Props Patterns#Render Props|Render Props]]
	- [[#3. Props Patterns#Polymorphic Components Using an `as` Prop|Polymorphic Components Using an `as` Prop]]
- [[#4. State Types|4. State Types]]
	- [[#4. State Types#`useState` Inference|`useState` Inference]]
	- [[#4. State Types#When Inference Is Enough|When Inference Is Enough]]
	- [[#4. State Types#Explicit `useState` Generic Types|Explicit `useState` Generic Types]]
	- [[#4. State Types#Nullable State|Nullable State]]
	- [[#4. State Types#Array State|Array State]]
	- [[#4. State Types#Avoiding `never[]`|Avoiding `never[]`]]
	- [[#4. State Types#Object State|Object State]]
	- [[#4. State Types#Union State|Union State]]
	- [[#4. State Types#Discriminated Union State|Discriminated Union State]]
	- [[#4. State Types#Functional State Updates|Functional State Updates]]
- [[#5. Event Types|5. Event Types]]
	- [[#5. Event Types#Inline Handler Inference|Inline Handler Inference]]
	- [[#5. Event Types#Button Click Events|Button Click Events]]
	- [[#5. Event Types#Input Change Events|Input Change Events]]
	- [[#5. Event Types#Textarea Change Events|Textarea Change Events]]
	- [[#5. Event Types#Select Change Events|Select Change Events]]
	- [[#5. Event Types#Form Submit Events|Form Submit Events]]
	- [[#5. Event Types#Keyboard Events|Keyboard Events]]
	- [[#5. Event Types#Mouse Events|Mouse Events]]
	- [[#5. Event Types#Focus and Blur Events|Focus and Blur Events]]
	- [[#5. Event Types#Drag Events|Drag Events]]
	- [[#5. Event Types#Clipboard Events|Clipboard Events]]
	- [[#5. Event Types#Generic Event Typing Patterns|Generic Event Typing Patterns]]
	- [[#5. Event Types#Event Object Types vs Handler Helper Types|Event Object Types vs Handler Helper Types]]
- [[#6. Refs|6. Refs]]
	- [[#6. Refs#`useRef` with DOM Elements|`useRef` with DOM Elements]]
	- [[#6. Refs#Mutable Refs for Values That Do Not Trigger Re-renders|Mutable Refs for Values That Do Not Trigger Re-renders]]
	- [[#6. Refs#Timer Ref|Timer Ref]]
	- [[#6. Refs#Forwarding Refs with `React.forwardRef`|Forwarding Refs with `React.forwardRef`]]
	- [[#6. Refs#`useImperativeHandle`|`useImperativeHandle`]]
	- [[#6. Refs#Typing Component Refs|Typing Component Refs]]
- [[#7. Forms|7. Forms]]
	- [[#7. Forms#Controlled Inputs|Controlled Inputs]]
	- [[#7. Forms#Uncontrolled Forms with `FormData`|Uncontrolled Forms with `FormData`]]
	- [[#7. Forms#Safely Reading Values from Form Elements|Safely Reading Values from Form Elements]]
	- [[#7. Forms#Reusable Input Components|Reusable Input Components]]
	- [[#7. Forms#Custom Submit Handler with Typed Values|Custom Submit Handler with Typed Values]]
	- [[#7. Forms#Typed State vs `FormData`|Typed State vs `FormData`]]
- [[#8. Context|8. Context]]
	- [[#8. Context#Creating Typed Context with a Real Default Value|Creating Typed Context with a Real Default Value]]
	- [[#8. Context#Context Initialized with `null`|Context Initialized with `null`]]
	- [[#8. Context#Custom Context Hook That Throws Outside Provider|Custom Context Hook That Throws Outside Provider]]
	- [[#8. Context#Provider Example|Provider Example]]
	- [[#8. Context#Context with Reducers|Context with Reducers]]
	- [[#8. Context#Avoid Unsafe Placeholder Defaults|Avoid Unsafe Placeholder Defaults]]
- [[#9. Reducers|9. Reducers]]
	- [[#9. Reducers#Counter Reducer|Counter Reducer]]
	- [[#9. Reducers#Exhaustiveness Checking with `never`|Exhaustiveness Checking with `never`]]
	- [[#9. Reducers#Todo Reducer|Todo Reducer]]
	- [[#9. Reducers#Typing Reducer Dispatch|Typing Reducer Dispatch]]
- [[#10. Custom Hooks|10. Custom Hooks]]
	- [[#10. Custom Hooks#Typing Hook Parameters|Typing Hook Parameters]]
	- [[#10. Custom Hooks#Hook Returning an Object|Hook Returning an Object]]
	- [[#10. Custom Hooks#Hook Returning a Tuple|Hook Returning a Tuple]]
	- [[#10. Custom Hooks#Generic `useLocalStorage`-Style Hook|Generic `useLocalStorage`-Style Hook]]
	- [[#10. Custom Hooks#Hook Accepting a Callback|Hook Accepting a Callback]]
	- [[#10. Custom Hooks#Hook Returning a DOM Ref|Hook Returning a DOM Ref]]
	- [[#10. Custom Hooks#Explicit Return Types for Hook APIs|Explicit Return Types for Hook APIs]]
- [[#11. Async Types|11. Async Types]]
	- [[#11. Async Types#Typing Promises|Typing Promises]]
	- [[#11. Async Types#Async Functions in Components|Async Functions in Components]]
	- [[#11. Async Types#Fetch Response Typing|Fetch Response Typing]]
	- [[#11. Async Types#Loading/Error/Data State|Loading/Error/Data State]]
	- [[#11. Async Types#Generic `useFetch<T>` Pattern|Generic `useFetch<T>` Pattern]]
	- [[#11. Async Types#Safe Error Handling with `unknown`|Safe Error Handling with `unknown`]]
- [[#12. Component Props Helpers|12. Component Props Helpers]]
	- [[#12. Component Props Helpers#`ComponentProps`|`ComponentProps`]]
	- [[#12. Component Props Helpers#`ComponentPropsWithoutRef`|`ComponentPropsWithoutRef`]]
	- [[#12. Component Props Helpers#`ComponentPropsWithRef`|`ComponentPropsWithRef`]]
	- [[#12. Component Props Helpers#`ElementRef`|`ElementRef`]]
	- [[#12. Component Props Helpers#`PropsWithChildren`|`PropsWithChildren`]]
	- [[#12. Component Props Helpers#`HTMLAttributes`|`HTMLAttributes`]]
	- [[#12. Component Props Helpers#`ButtonHTMLAttributes`|`ButtonHTMLAttributes`]]
	- [[#12. Component Props Helpers#`InputHTMLAttributes`|`InputHTMLAttributes`]]
	- [[#12. Component Props Helpers#`AnchorHTMLAttributes`|`AnchorHTMLAttributes`]]
	- [[#12. Component Props Helpers#`ChangeEventHandler`|`ChangeEventHandler`]]
	- [[#12. Component Props Helpers#`MouseEventHandler`|`MouseEventHandler`]]
	- [[#12. Component Props Helpers#`Dispatch`|`Dispatch`]]
	- [[#12. Component Props Helpers#`SetStateAction`|`SetStateAction`]]
- [[#13. DOM and HTML Attribute Types|13. DOM and HTML Attribute Types]]
	- [[#13. DOM and HTML Attribute Types#Extending Native Element Props|Extending Native Element Props]]
	- [[#13. DOM and HTML Attribute Types#Typing Buttons|Typing Buttons]]
	- [[#13. DOM and HTML Attribute Types#Typing Inputs|Typing Inputs]]
	- [[#13. DOM and HTML Attribute Types#Typing Links|Typing Links]]
	- [[#13. DOM and HTML Attribute Types#Typing Divs and Spans|Typing Divs and Spans]]
	- [[#13. DOM and HTML Attribute Types#Passing Through Native Props with Rest/Spread|Passing Through Native Props with Rest/Spread]]
	- [[#13. DOM and HTML Attribute Types#Choosing Between `HTMLAttributes`, Specific Attributes, and `ComponentPropsWithoutRef`|Choosing Between `HTMLAttributes`, Specific Attributes, and `ComponentPropsWithoutRef`]]
- [[#14. Advanced Patterns|14. Advanced Patterns]]
	- [[#14. Advanced Patterns#Generic Components|Generic Components]]
	- [[#14. Advanced Patterns#Generic Table Component with Typed Columns|Generic Table Component with Typed Columns]]
	- [[#14. Advanced Patterns#Conditional Props|Conditional Props]]
	- [[#14. Advanced Patterns#Mutually Exclusive Props Using `never`|Mutually Exclusive Props Using `never`]]
	- [[#14. Advanced Patterns#Discriminated Union Props|Discriminated Union Props]]
	- [[#14. Advanced Patterns#Controlled vs Uncontrolled Component Prop Union|Controlled vs Uncontrolled Component Prop Union]]
	- [[#14. Advanced Patterns#Compound Components|Compound Components]]
	- [[#14. Advanced Patterns#Higher-Order Component That Preserves Props|Higher-Order Component That Preserves Props]]
	- [[#14. Advanced Patterns#Type-Safe Component Maps|Type-Safe Component Maps]]
	- [[#14. Advanced Patterns#Type-Safe Variants|Type-Safe Variants]]
- [[#15. Common Mistakes|15. Common Mistakes]]
	- [[#15. Common Mistakes#Mistake: Overusing `any`|Mistake: Overusing `any`]]
	- [[#15. Common Mistakes#Mistake: Incorrect Children Typing|Mistake: Incorrect Children Typing]]
	- [[#15. Common Mistakes#Mistake: Incorrect Event Typing|Mistake: Incorrect Event Typing]]
	- [[#15. Common Mistakes#Mistake: `useState([])` Becoming `never[]`|Mistake: `useState([])` Becoming `never[]`]]
	- [[#15. Common Mistakes#Mistake: Unsafe Context Defaults|Mistake: Unsafe Context Defaults]]
	- [[#15. Common Mistakes#Mistake: Confusing `JSX.Element`, `ReactNode`, and `ReactElement`|Mistake: Confusing `JSX.Element`, `ReactNode`, and `ReactElement`]]
	- [[#15. Common Mistakes#Mistake: Incorrect Ref Typing|Mistake: Incorrect Ref Typing]]
	- [[#15. Common Mistakes#Mistake: Overusing `React.FC`|Mistake: Overusing `React.FC`]]
	- [[#15. Common Mistakes#Mistake: Not Narrowing Nullable Values|Mistake: Not Narrowing Nullable Values]]
	- [[#15. Common Mistakes#Mistake: Incorrectly Typing Async Data|Mistake: Incorrectly Typing Async Data]]
	- [[#15. Common Mistakes#Mistake: Assuming `response.json()` Is Automatically Type-Safe|Mistake: Assuming `response.json()` Is Automatically Type-Safe]]
	- [[#15. Common Mistakes#Mistake: Creating Overly Broad Prop Types|Mistake: Creating Overly Broad Prop Types]]
- [[#16. Quick Reference Tables|16. Quick Reference Tables]]
	- [[#16. Quick Reference Tables#React Children Types|React Children Types]]
	- [[#16. Quick Reference Tables#Common Event Types|Common Event Types]]
	- [[#16. Quick Reference Tables#Common DOM Element Types|Common DOM Element Types]]
	- [[#16. Quick Reference Tables#Common Utility and Helper Types|Common Utility and Helper Types]]
	- [[#16. Quick Reference Tables#Hooks and Their Type Patterns|Hooks and Their Type Patterns]]
	- [[#16. Quick Reference Tables#Native HTML Prop Helper Types|Native HTML Prop Helper Types]]
	- [[#16. Quick Reference Tables#Common `useState` Typing Scenarios|Common `useState` Typing Scenarios]]
	- [[#16. Quick Reference Tables#Common Ref Typing Scenarios|Common Ref Typing Scenarios]]
- [[#Final Practical Rules|Final Practical Rules]]
	- [[#Final Practical Rules#Prefer Inference When|Prefer Inference When]]
	- [[#Final Practical Rules#Write Explicit Types When|Write Explicit Types When]]
	- [[#Final Practical Rules#Avoid `any`|Avoid `any`]]
	- [[#Final Practical Rules#Avoid Unsafe Assertions|Avoid Unsafe Assertions]]
	- [[#Final Practical Rules#Model Impossible States with Discriminated Unions|Model Impossible States with Discriminated Unions]]
	- [[#Final Practical Rules#Type Reusable Components Without Losing Native Props|Type Reusable Components Without Losing Native Props]]
	- [[#Final Practical Rules#Safely Type Nullable Values|Safely Type Nullable Values]]
	- [[#Final Practical Rules#Choose `ReactNode`, `ReactElement`, and `JSX.Element` Correctly|Choose `ReactNode`, `ReactElement`, and `JSX.Element` Correctly]]
